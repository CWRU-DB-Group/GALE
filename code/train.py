...
flags.DEFINE_integer('active_epochs', 520, 'Number of active epochs to continue training discriminator.')
flags.DEFINE_integer('sample_size',10, 'sample size per epoch in active learning')
