...
flags.DEFINE_string('datasetname', 'species_error', 'Dataset to be used.')
flags.DEFINE_string('datapath',"dataset/species/","Dataset path")
...
flags.DEFINE_float("lamda", 0.0003, "lamda in the approximation algo.")
flags.DEFINE_boolean('pca_flag',True,'whether to use PCA as preprocessing')
