...
for epoch in range(FLAGS.epochs):
    ...
    _, _, correct, masked_t_pre, masked_t_label,discriminator_loss, generator_loss, discriminator_unsupervised_loss, discriminator_real_data_loss, discriminator_fake_data_loss, discriminator_gradients =sess.run([model.d_opt, model.g_opt, model.masked_correct,
                                                                  model.masked_pred_class, model.masked_labels,model.d_loss, model.g_loss,model.unsupervised_loss, model.real_data_loss, model.fake_data_loss, model.d_gradients] , feed_dict=feed_dict)
    num_correct += correct
